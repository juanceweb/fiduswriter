...
const richtextTemplate = ({
    id = "",
    title = "",
    elements = ["paragraph", "heading1", "heading2", "heading3", "heading4", "heading5", "heading6", "figure", "ordered_list", "bullet_list", "horizontal_rule", "equation", "citation", "cross_reference", "blockquote", "footnote", "actividades","lectura_obligatoria","para_reflexionar","video","encuesta","leer_con_atencion","texto_aparte","ejemplo","lectura_recomendada"],
    marks = ["strong", "em", "underline", "link"],
    locking = "false",
    optional = "false",
    language = false,
