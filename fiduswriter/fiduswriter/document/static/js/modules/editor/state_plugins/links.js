    ...
    return new Plugin({
        ...
        appendTransaction: (trs, oldState, newState) => {
            ...
            newState.doc.descendants((node, pos) => {
                if (node.type.groups.includes("heading") || ["figure", "table", "bullet_list", "ordered_list","actividades","cita","lectura_obligatoria","para_reflexionar","video","interactivo"].includes(node.type.name)) {
